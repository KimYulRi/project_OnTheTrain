          ...
          <div class="modal-body">
            <div>
              <ul>
                ...
                <li>
                  원하시는 좌석을 선택 후 [선택좌석 예약하기] 버튼을 클릭하시면
                  예약이 완료됩니다.
                </li>
                <li>
                  원하지 않는 좌석이 선택된 경우에는 좌석을 한 번 더 클릭하시면
                  취소됩니다.
                </li>
              </ul>
            </div>
            ...
            <div class="seats" align="center">
              <table>
                <tbody>
                  ...
                  <tr>
                    <td>
                    	<input type="text" style="width: 30px; border:none; font-weight: bold;" class="depPlaceText">
                    ...
                    <td>>>>>>>></td>
                    <td>
                    	<input type="text" style="width: 30px; border:none; font-weight: bold;" class="arrPlaceText">
