		...
		<div class="main-container">
			...
			<div class="contentArea">
				<div>
						...
						<div id="carouselExampleAutoplaying" class="carousel slide"
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img src="${ path }/images/accommodation/banner1.png"
										class="d-block w-100" alt="...">
								</div>
								<div class="carousel-item">
									<img src="${ path }/images/accommodation/banner2.png"
										class="d-block w-100" alt="...">
								</div>
								<div class="carousel-item">
									<img src="${ path }/images/accommodation/banner3.png"
										class="d-block w-100" alt="...">
								</div>
							</div>
					...
					<div>현재 예약 가능한 숙소가 얼마 남지 않았으므로, 서둘러 예약하세요.</div>
					<div id="pCount">숙소44개</div>
				</div>
				<!-- 숙박 목록 -->
				<div class="listArea">
			...
			<div id="schedulerArea">
			<%@ include file="./scheduler/schedulerMain.jsp"%>
			</div>
